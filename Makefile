...
# he-codeco.eu/codecoapp-operator-bundle:$VERSION and he-codeco.eu/codecoapp-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= he-codeco.eu/codecoapp-operator
...
docker-buildx: test ## Build and push docker image for the manager for cross-platform support
	...
	- docker buildx build --push --platform=$(PLATFORMS) --build-arg VERSION=$(VERSION_GOLANG) --tag ${IMG} -f Dockerfile.cross .
